...
1. Desenvolvimento local (ver `LOCAL-DEV.md`)
2. Rodar testes (ver `TESTING.md`)
3. Seguir checklist (ver `CHECKLIST_RELEASE_EQUIPE.md`)
4. Deploy em producao (ver `OPERATIONS.md`)
